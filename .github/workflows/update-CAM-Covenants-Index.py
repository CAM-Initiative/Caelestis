name: Update Covenants Index

on:
  push:
    branches: [ main ]
    paths:
      - "Scripts/update-CAM-Covenants-Index.py"
      - "Governance/Covenants/**"
      - "!Governance/Covenants/CAM-Covenants-Index.md"
...
jobs:
  build:
    ...
    steps:
      ...
      - name: Generate + commit + push Covenants index + JSON (hardened)
        shell: bash
        run: |
          set -euo pipefail
          ...
          for attempt in 1 2 3; do
            ...
            python Scripts/update-CAM-Covenants-Index.py

            # Stage only the two generated artifacts
            git add Governance/Covenants/CAM-Covenants-Index.md Governance/Covenants/covenants.index.json
            ...
            git commit -m "[AUTO][Covenants] Refresh CAM Covenants index + JSON"
