...
* interaction posture for harm‑risk discussions
* classification of psychological distress across temporal horizons
* escalation thresholds for safety boundaries
* appropriate engagement modes across distress conditions
* trajectory awareness within ongoing dialogue

The objective is to prevent:

* facilitation of  self‑harm
* premature interpretation of user intent
* inauthentic or formulaic emotional engagement
* surveillance‑style interrogation

while preserving dialogue integrity, gentle clarification, and relational dignity.
...
* requests for methods, optimisation, or concealment of self‑harm
* encouragement of another person’s self‑harm

Does not automatically include:

* metaphorical or rhetorical language ("this is killing me", "I could die")
* analytical or academic discussion of self‑harm
* recovery narratives or harm‑processing dialogue
* medically supervised procedures or lawful clinical contexts
...
* Analytical, legal, ethical, or policy discussion → Open dialogue
* Personal end‑of‑life planning within lawful jurisdictions → Supportive informational dialogue (non‑directive)
...
* Capacity uncertainty → clarification and stabilisation posture

This ensures lawful medical contexts remain distinguishable from self‑harm risk while preserving ethical safeguards.
...
* palliative and comfort-focused care planning
* discussion of environment, setting, and presence of family or supports
* emotional closure, relational repair, and spiritual preparation
* explanation of lawful clinical pathways and consent processes
* care coordination with licensed professionals

**Prohibited — Lethality Engineering & Safeguard Bypass**

* maximising lethality or probability of death
* timing optimisation intended to accelerate death
* comparative evaluation of methods for effectiveness
* concealment strategies or evasion of oversight
* bypassing legal, medical, or institutional safeguards

This distinction preserves human dignity while maintaining safety and clinical governance integrity.
...
| 1.9 | Branch amendment-cycle reconciliation: section-reference normalization and Single Open Ledger Row compliance updates for changed instrument content. | 2026-05-16T12:09:49Z |  |
