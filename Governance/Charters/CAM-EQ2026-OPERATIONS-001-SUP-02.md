...
**Purpose:** Defines operational escalation maps, authority routing trees, and horizon-aligned escalation pathways (H0–H2).

---

## 1. Purpose

This Supplement instantiates Supplementary 2 referenced in CAM-EQ2026-OPERATIONS-001 §10.3.

---

## 2. Scope

This Supplement applies to escalation mapping, authority routing, and pathway selection for operational governance actions below planetary legitimacy thresholds.
