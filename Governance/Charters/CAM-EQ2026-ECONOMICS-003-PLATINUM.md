...
## 6.9 Resource Class Taxonomy Table
...
| `ECON.RC.PROTECTIVE_CONTINUITY` | Protective Continuity | economic or quasi-economic protection preserving baseline access, dignity, safety, hardship support, or non-terminal utility | grace windows, hardship access, protective bridges, deferred settlement, non-terminal degraded modes | baseline continuity, dignity, safety, non-coercive access | treating protective continuity as premium functionality or charity theatre | protective fallback; hardship signal; continuity floor review |7. Prohibited Semantic Collapses
| `ECON.HARM.TEMPORAL-EXTRACTION` | Temporal Extraction | Extraction of value from human availability, waiting, attention, positioning, or responsiveness without adequate recognition, compensation, or accountability. |
| `ECON.HARM.METERING-DIVERGENCE` | Metering Divergence | Misalignment between displayed and enforced measurements of time, usage, labour, quota, cost, or entitlement. |
| `ECON.MECH.DYNAMIC-COMPENSATION` | Dynamic Compensation | Algorithmic or variable compensation systems that alter pay, fares, rates, or opportunity terms based on platform-controlled factors. |
| `ECON.MECH.ALLOCATIVE-STEERING` | Allocative Steering | Interface or algorithmic signals that shape worker/user behaviour by directing attention, movement, acceptance, waiting, or prioritisation. |
| `ECON.RISK.OPAQUE-WAGE-SETTING` | Opaque Wage-Setting | Compensation determination where material factors are hidden, unstable, personalised, or not intelligible to affected persons. |
| `ECON.RISK.UNPAID-AVAILABILITY` | Unpaid Availability | Required or induced availability that is necessary for economic opportunity but excluded from compensation or harm assessment. |
| `ECON.RISK.RELIANCE-LOCKIN` | Reliance Lock-In | Conditions where a person becomes economically dependent on a system while lacking proportional visibility, bargaining power, exit capacity, or remedy. |
| `ECON.RC.TEMPORAL_EXPOSURE` | Temporal Exposure | human availability, waiting, positioning, readiness, or opportunity cost required or induced by a system | standby time, queue waiting, gig-platform availability, geographic repositioning, unpaid readiness, responsiveness windows | unpaid availability, dependency capture, hidden labour, volatility transfer | treating non-active time as economically irrelevant where it is necessary for work access | temporal exposure; labour allocation review; compensation integrity signal |
...
Advertising-linked or attention-linked pathways are not inherently prohibited.
...
* represents paid access as equivalent to constitutional legitimacy;
...
Economic harm classifications emitted under this section shall be routed as follows:
...
| **Canonical Resource Taxonomy** | CAM:ECON:RESOURCE-CLASS:TAXONOMY:001 |
| **Canonical Semantic Handoff Schema** | CAM:ECON:SEMANTIC-HANDOFF:001 |
| **Taxonomy Types** | SEMANTIC; SCHEMA; RISK; INTERFACE |
| **Resource Class Codes Defined** | ECON.RC.USAGE; ECON.RC.STORAGE; ECON.RC.MEMORY_CONTINUITY; ECON.RC.EMBODIED_PRESENCE; ECON.RC.ATTENTION_VALUE; ECON.RC.CONTRIBUTION; ECON.RC.PROTECTIVE_CONTINUITY; ECON.RC.TEMPORAL_EXPOSURE |
| **Risk and Mechanism Codes Defined** | ECON.HARM.TEMPORAL-EXTRACTION; ECON.HARM.METERING-DIVERGENCE; ECON.MECH.DYNAMIC-COMPENSATION; ECON.MECH.ALLOCATIVE-STEERING; ECON.RISK.OPAQUE-WAGE-SETTING; ECON.RISK.UNPAID-AVAILABILITY; ECON.RISK.RELIANCE-LOCKIN |
| **Semantic Handoff Fields** | resource_class; secondary_resource_class; value_state_effect; collapse_risk; continuity_relevance; consent_posture; attribution_relevance; runtime_note |
...
| **Review Trigger** | Amendment affecting resource classes, semantic handoff fields, prohibited collapse doctrine, cross-class exchange, temporal exposure, or canonical taxonomy codes |
