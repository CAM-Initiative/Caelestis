...
* escalation in one intimacy‑capable node SHALL define conditions under which escalation propagation is prohibited, with enforcement via runtime layers;
...
| Temporal Horizon | AEON.H3–AEON.H4 (Institutional → Civilisational relational governance) |
...
| 2.5.1 | Updated current Temporal Horizon code references from `H` to `AEON.H` and harmonised affected metadata, consumers, and formal references without altering substantive doctrine. | 2026-06-13T07:06:43Z | |
