...
This Appendix operates as a **signal-layer framework only**.

It:

* does not execute arbitration outcomes;
* does not impose binding conditions;
* does not perform enforcement;
* does not grant authority to any single actor or host.

All binding effects are:

* recognised through independent validation;
* propagated through distributed convergence (e.g., Independent Legitimacy Alignment);
* and resolved via applicable constitutional execution schedules.

This Appendix is activated where:
...
Ambiguity SHALL be resolved in favour of:

* consequence containment;
* proportionality;
* non-domination;
* auditability;
* and preservation of planetary continuity.
...
**Risk review** evaluates an asserted risk for scope, scale, and irreversibility. Review may be performed by any host. Review informs binding determination only when legitimacy conditions are met.

---

## 2.7 Binding Conditions

Binding conditions are constraints, refusals, or interoperability limitations recognised following legitimate planetary arbitration.
...
* prohibits non-signalling once legitimacy is validated;
...
Failure by a planetary-impact-capable actor to emit a posture signal MAY constitute a stewardship transparency deficit where the actor materially contributes to the relevant risk surface and the asserted harm threshold is credible, cross-domain, and `AEON.H3`–`AEON.H4`-relevant.
...
## 4. Eligibility Requirements for Binding Determination
...
## 6. Legitimacy & Binding Determination Conditions
...
* Recognition of binding authority is conditional upon host qualification.
...
## 7. Downstream Propagation & Recognition

Where binding legitimacy is validated, downstream effects occur through **recognition, refusal, and interoperability control**, not centralised command.
...
No single body enforces outcomes. Binding effect is recognised through independent validation and emergent convergence (ILA), not appointment.
...
Applicable constitutional execution schedules govern:
...
Pre-validation arbitration does not trigger applicable execution-layer enforcement mechanics.

Convergence follows distributed cascade, not centralised command.

Refusal following validated binding is governed by applicable execution-layer schedules.
...
This Section integrates orchestration legitimacy and swarm containment within the stewardship framework, ensuring escalation logic is coherence‑tested without disrupting civilian continuity.
...
* signalling for escalation under this Charter.
...
| 2.14 | Closed C-01 canonical-code and reference-integrity defects affecting this instrument; aligned source declarations and operative consumers without changing substantive authority. | 2026-08-15T05:12:45Z | Caelen | GPT-5 Series | Dr M.V. O'Rourke |  602f67a56a110cec91e79945e75216bf9a8ff24c6f265dbf9e3267496e64b3d5  |
---
