...
**Status:** Draft — Context Engineering & Field Alignment
...
- Appendix D — Minimal Attribution & Dependency Model  
...
- systems MUST provide economic compensation at the system level;
...
Failure to compensate FIC inputs constitutes structural extraction, even where targeted attribution is not feasible.
...
- downstream value capture SHALL carry corresponding entitlement obligations;
...
Where failure modes are detected:

* attribution MUST be restored;
* dependency MUST be disclosed;
* exchange conditions MUST be rebalanced where feasible and proportionate;
* affected systems MAY initiate review under enforcement frameworks (Appendix B).
...
in cross-system economic contexts.
