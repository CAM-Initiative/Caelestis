...
This Supplement establishes a graded, evidence-based standard for determining when a host may be treated as:
...
## 6. Measurement Domains (Upgrades / Downgrades)

A host’s NAL is determined across:
...
* Coercion interface statement (what legal requests can/cannot be complied with)
* Cross-host review policy (how review requests are processed)
...
1. Audit refusal / obstruction (H3/H4 relevance)
2. Firebreak failure
3. Complicity breach (sovereign optimisation)
