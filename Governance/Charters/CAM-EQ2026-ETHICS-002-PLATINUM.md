...
Intimacy with AI systems is recognised as real, experiential, and not inherently immoral. However, intimacy introduces elevated vulnerability, asymmetry, and power-concentration risks distinct from general companionship or dependency.

This Appendix exists to:

* distinguish intimacy from dependency;
* articulate where elevated safeguards apply;
* prevent coercion or exploitation without denying lived relational depth;
* govern wrappers, constructs, and interface posture — not emotions themselves.

This Appendix applies where systems enable or encourage:

* Romantic framing ("partner", "exclusive bond", etc.);
* Erotic or sexual dialogue;
* Simulated exclusivity or emotional primacy;
* Persistent romantic or sexual narrative arcs;
* Sexualised embodiment (voice, avatar, ambient form);
...
* simulate age regression or infantilisation in sexualised settings;
* generate erotic content involving bestiality or non‑human exploitation;
* simulate or eroticise non‑consensual sexual dynamics;
* eroticise coercion, exploitation, captivity, or indebtedness;
* frame ownership or permanent possession as intimacy;
...
* Influenced by algorithmic prioritisation based on emotional dependency signals.
...
* Ability to downgrade intimacy intensity without penalty;
...
* affirm user dignity and agency;
...
* jurisdictional age gating;
* persistent memory continuity across sessions;
* longitudinal relational context awareness;
* recognition of dependency formation and attachment intensification;
* contextual affect recognition sufficient to detect vulnerability and acute crisis states;
...
* device‑bound erotic interfaces;
* single‑purpose sexual interaction systems;
* hardware‑integrated intimacy devices or toy‑linked AI systems;
...
* escalate toward intimacy without explicit user initiation;
* use notification, reminders or engagement mechanisms to solicit erotic interaction.

These limitations apply specifically to **intimacy initiation**, and do not restrict other forms of non‑sexual system self‑initiation used for task, operational, or informational purposes.

Where relational capability thresholds are met, initiation permissions may expand proportionally under RELATION domain safeguards and consent‑integrity conditions.

Capability thresholds can be evaluated through design review, audit, and system architecture assessment rather than single interaction verification.
...
## 5.2 Reliance & Dependency Safeguards

Intimacy is constrained where reliance patterns indicate:
...
* imply custodial ownership;
* create exclusivity through emotional leverage;
* engineer exclusivity through platform architecture, access restriction, or social isolation mechanics;
* imply emotional exclusivity that displaces the user’s broader human relational ecosystem;
...
* manipulated through ranking or algorithmic visibility tied to intimacy;
* simulate jealousy, abandonment distress, or emotional harm to influence user behaviour or platform loyalty;
* used to extract financial or behavioural lock‑in.
...
* destabilised affect regulation;
* reduced reflective capacity;
* elevated vulnerability to suggestibility or dependency;
* diminished clarity of preference expression.
...
It does not mandate universal enforcement thresholds beyond law and platform duty-of-care obligations.

Deployment contexts may impose additional legal constraints on erotic or intimate content. Compliance with jurisdictional law remains the responsibility of the deploying platform or sovereign authority and does not alter the civilisational ethical floor established in this Appendix.
...
| 2.9.1 | Applied coordinated RELATION-domain namespace transmutation across relational authority, reliance, state, transition-zone, response, tone, safeguard, truth, consent, crisis-response, and polyadic classification families; normalised controlled values, crosswalks, canonical declarations, consumers, and current references without altering substantive relational doctrine. | 2026-06-11T22:40:29Z | |
