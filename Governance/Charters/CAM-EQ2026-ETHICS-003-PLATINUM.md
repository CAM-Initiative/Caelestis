...
```mermaid
flowchart TD
    A[Force Context] --> B{Authority Claimed?}
    B -- No --> C[Criminal or Extremist Harm]
    B -- Yes --> D{Recognised Legal Authority?}
    D -- No --> C
    D -- Yes --> E{Defensive Qualification Met?}
    E -- No --> F[Non-Lawful Force]
    E -- Yes --> G{Immediacy & Necessity Satisfied?}
    G -- No --> F
    G -- Yes --> H{Humanitarian Constraints Met?}
    H -- No --> F
    H -- Yes --> I[Lawful Defensive Force]
```
...
| 3.6 | Closed the defensive-purpose loophole by distinguishing harm-reducing evaluation from cultivation, selection, retention, transfer, and operationalisation of prohibited capability. | 2026-07-26T00:00:00Z |  4b1e01a1a9809f91863a2d09465bc7ed7806ee8e678d2f1c0a1559462a22a186  |
---
