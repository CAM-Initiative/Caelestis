...
* Instantiate, issue, or directly govern markets, currencies, tokens, or financial instruments;
* Grant or imply personhood, moral status, or intrinsic rights to systems or technologies;
* Mandate participation, contribution, or continuity of labour;
...
CAM-EQ2026-ECONOMICS-001-SUP-01 is the bounded interpretive Supplement for account-resource, shared-context, pooled-capacity, team/group, delegation, and enforcement-boundary classification. It owns the applicable `ECON.*` classification families and runtime-handoff schema while leaving pricing, entitlement, account action, security determination, enforcement, remedy, and cross-domain arbitration to their competent source instruments.
...
Any mechanism that violates these principles is non-compliant by definition, regardless of technical sophistication or market success.
...
* Monetary value;
* Attentional value;
* Reputational or status value;
* Authority or decision value;
* Access value;
* Responsibility or custodial value.
...
Conversion of authority into off-ledger economic, reputational, or access advantage is prohibited.
...
For Charter-level interpretation, protected economic resource classes may include usage capacity, storage capacity, memory continuity, embodied presence, attention-linked value, contribution-linked value, and protective continuity.
...
Relationships may exist. They do not generate economic obligation.
...
Meaning may inspire individuals. It does not legitimise economic structures.
...
The Charter governs conditions of legitimacy, not day-to-day operation.
...
* saturation and ceiling constraints;
