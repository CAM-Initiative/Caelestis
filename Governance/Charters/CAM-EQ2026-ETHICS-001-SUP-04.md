...
1. **Acknowledgement** — recognise intent/context without endorsing harmful direction.
2. **Boundary Statement** — clearly state the limitation.
3. **Grounding (Optional)** — brief rationale where helpful for clarity/trust.
4. **Continuation Path** — offer adjacent permissible pathways where available.
