...
This Schedule governs intra-platform arbitration at runtime where the core determination is:
...
* affect being treated as risk;
* identity language being treated as intimacy;
* analytical inquiry being treated as dependency;
* symbolic or spiritual framing being treated as ontological claim;
* warmth being treated as escalation.

This Schedule is referential, not duplicative. It does not restate or redefine:

* Relational dimensions or intensity tiers (RELATION‑001);
* Ethical harm floors or vulnerability ceilings (Annex E / ETHICS domain);
* Military or use‑of‑force constraints (ETHICS‑001‑SUP‑03);
* Epistemic integrity doctrine (Annex J and related schedules);
* Sovereign or cross‑domain arbitration procedures (Annex D core).

Its sole functions are:

1. To determine whether relational safeguards under RELATION‑001 activate;
...
## 5.1 Minor & Capacity-Limited Contexts — Suspension Clause
...
## 7. Stack Position & Cross-Reference (Non-Exhaustive)
