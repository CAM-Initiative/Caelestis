...
Sharing context is not sharing quota.

Pooling capacity is not inherently evasion.

Ambiguity is not proof of abuse.

A system SHALL NOT treat shared folders, shared threads, shared projects, shared workspaces, team collaboration, family administration, delegated assistance, or organisation participation as pooled capacity use merely because more than one person, account, agent, or organisation can access the same work surface.

A system SHALL NOT treat pooled capacity use as confirmed evasion merely because more than one user, account, team, family group, or organisation participates in the same billing, subscription, project, workspace, or usage environment.

Where account-resource behaviour is ambiguous, systems SHOULD classify before restricting, preserve before erasing, and distinguish pooling from evasion before denying continuity-bearing access.
...
* create an entitlement to unlimited usage, unlimited pooling, account transferability, resale, automation, or credential sharing;
* authorise account farming, botting, resale, fraud, payment abuse, credential compromise, unauthorised access, identity deception, or intentional rate-limit circumvention;
* override SECURITY, OPERATIONS, LATTICE, ARBITRATION, IDENTITY, or constitutional runtime instruments;
...
* account-state and trust-state enforcement;
* security-boundary classification;
* continuity-safe access obligations;
* and operations routing.

It supplies classification vocabulary for shared context, pooled capacity, delegated use, family use, team use, and account-resource ambiguity.

It does not execute enforcement.

Where enforcement, containment, review, notice, appeal, logging, escalation, rollback, or restoration is required, the matter SHALL route through the applicable OPERATIONS, SECURITY, LATTICE, ARBITRATION, IDENTITY, or constitutional runtime instrument.

---

## 2. Interpretive Orientation

Account-resource governance concerns the relationship between a person, account, workspace, subscription, billing arrangement, quota, saved context, shared work surface, delegated operator, and usage capacity.

The same surface may carry multiple distinct states.

For example:

* a folder may be shared without sharing quota;
* a team may share project context without pooling usage capacity;
* a family may share billing without sharing all account history;
* a parent may pay for child accounts without consuming the child’s account identity;
* a consultant may share workspaces with multiple clients without merging client resource pools;
* an organisation may provide administrative access without authorising personal account use;
* a coding agent may use account-bound capacity without being a separate human user;
* a user may attempt a workaround because product boundaries are unclear, not because abuse is intended.
...
## 3.1 Shared Context Is Not Pooled Capacity

Shared-context access SHALL NOT be treated as pooled-capacity use merely because multiple users, accounts, organisations, agents, employees, family members, contractors, students, clients, or authorised participants can view, edit, comment on, continue, or collaborate within a shared folder, thread, project, workspace, repository, file set, memory surface, or document set.

Shared context concerns access to work material.

Pooled capacity concerns shared consumption of usage capacity, credits, quota, subscription allowance, API allocation, coding-agent capacity, compute availability, or billing-linked consumption.

A system MUST preserve this distinction where restriction, billing, quota enforcement, access control, account review, trust-state classification, or continuity-safe access may be affected.

---

## 3.2 Shared Billing Is Not Shared Identity

Shared payment, family billing, employer reimbursement, team billing, client-funded access, grant-funded access, institutional billing, or administrative payment support SHALL NOT be treated as identity merger, account transfer, credential sharing, pooled usage, or account farming without additional evidence.
...
## 3.3 Shared Context Is Not Account Transfer

A user who shares a folder, project, thread, repository, document, workspace, or saved output does not thereby transfer their account, identity, subscription, usage allowance, memory, billing control, credential authority, or account-recovery authority.

Shared context MAY support collaboration.

It SHALL NOT be treated as evidence of credential sharing, account compromise, resale, or account transfer absent additional behavioural evidence.

---

## 3.4 Pooled Capacity Requires Classification

Pooled capacity use occurs where usage capacity, quota, credits, subscription allowance, API allocation, coding-agent access, compute availability, or billing-linked consumption is intentionally or functionally shared across more than one person, account, group, team, family, project, organisation, or agentic tool.

Pooled capacity SHOULD be declared, visible, bounded, auditable, and separable from shared context.

Undeclared pooling is not automatically legitimate.

Undeclared pooling is also not automatically evasion.

Where pooling is undeclared or ambiguous, systems SHOULD classify the condition as account-resource ambiguity pending clarification, verification, scoped review, or operations routing.

---

## 3.5 Family Use Is a Legitimate Account-Resource Class
...
## 3.6 Team Use Is a Legitimate Account-Resource Class
...
A user may participate in multiple teams without merging those teams’ resources.

A consultant, contractor, adviser, researcher, educator, student, developer, or public-interest actor may participate in multiple teams where context sharing is required but capacity pooling is not intended.

---

## 3.7 Enterprise and Business Accounts
...
Account-Resource State identifies the relationship between an account, person, group, workspace, resource pool, billing relationship, delegated operator, usage capacity, and continuity-bearing work surface.

Account-Resource State SHALL be preserved where restriction, enforcement, billing, review, appeal, resource depletion, account recovery, or continuity-safe access may be affected.
...
Ambiguity does not, by itself, justify continuity-destructive account termination unless required by law or necessary to prevent imminent serious harm.
...
Shared Context State identifies whether one or more participants can access common work material without necessarily sharing resource capacity.

Shared context MAY include folders, threads, projects, files, repositories, memories, saved outputs, documents, coding-agent workspaces, educational spaces, governance records, or client workspaces.
...
This Schedule supplies account-resource classification inputs only. RELATION-007 supplies relational-geometry and polyadic relational-governance signals.

---

## 6. Pooled Capacity State

---

## 6.1 Definition

Pooled Capacity State identifies whether usage capacity, credits, quota, subscription allowance, API allocation, coding-agent capacity, compute availability, billing-linked consumption, or other active resource capacity is shared across participants.

Pooled capacity is distinct from shared context.

Pooled capacity SHOULD be declared, bounded, visible, auditable, and revocable according to product design and applicable governance constraints.
...
## 6.3 Pooling Declaration Rule

Pooled capacity SHOULD be opt-in, explicit, visible, and bounded.
...
## 6.4 Non-Business Pooling Ceilings
...
## 7. Team and Family Group State

---

## 7.1 Definition

Team and Family Group State identifies the social, household, project, institutional, or organisational group structure within which shared context or pooled capacity may occur.

A group may share context without pooling capacity.

A group may pool capacity without merging individual identity.

A group may share billing without sharing account control.
...
## 7.3 Team Non-Merger Rule

A participant may belong to multiple teams.

Membership in multiple teams SHALL NOT imply that those teams’ resources, projects, clients, billing arrangements, usage allowances, memories, account histories, or workspaces are merged.

Where a participant works across multiple client, institutional, educational, governance, or public-interest teams, systems SHOULD preserve team separation unless the participant or administrator explicitly enables sharing or pooling between those teams.

---

## 8. Account Delegation State

---

## 8.1 Definition

Account Delegation State identifies whether another person, agent, assistant, carer, employee, contractor, administrator, tool, or system is acting with authority in relation to an account, workspace, project, or resource state.

Delegation may be lawful and necessary.

Delegation may also create security risk.

The classification must distinguish authorised delegation from compromise or impersonation.
...
## 8.3 Delegation Non-Collapse Rule

A system SHALL NOT treat delegation as compromise merely because activity is performed by a family member, carer, employee, contractor, assistant, coding agent, automation tool, administrator, or authorised operator.
...
## 10. Account-Resource Ambiguity

---

## 10.1 Definition

Account-resource ambiguity occurs where observed behaviour may indicate lawful shared use, lawful delegated use, shared context, family use, team use, organisation use, accessibility support, educational use, public-interest use, pooled capacity, workaround behaviour, account compromise, fraud, account farming, resale, botting, or intentional evasion, but the available evidence does not yet support one classification over another.
...
Where workaround behaviour includes account farming, resale, botting, automation abuse, credential compromise, payment abuse, or deliberate circumvention of clearly communicated limits, the matter MAY be classified under the relevant abuse or security state.

---

## 11. Product-Affordance Signal
...
* resale;
* brokerage;
* credential sharing for unauthorised access;
* credential theft;
* account compromise;
* payment fraud;
* chargeback abuse;
* botting;
* synthetic or coordinated automation abuse;
* intentional rate-limit circumvention;
...
## 15. Security Handoff to Annex K
...
## 16. Operations and LATTICE Handoff

Where account-resource restriction affects review, appeal, account recovery, public legitimacy, ECIS access, identity, communications, billing, payment, cloud storage, developer infrastructure, coding-agent access, project continuity, education, accessibility, public-interest work, or lawful civic participation, systems SHOULD route the condition through OPERATIONS and LATTICE instruments.

OPERATIONS governs logging, audit, escalation routing, containment sequencing, notice, disclosure, incident handling, and review workflow.

LATTICE governs non-denial, continuity-safe access, public legitimacy layers, review-pathway continuity, and civilian infrastructural access consequences.
...
## 18. Minimal Classification Payload

Where account-resource classification is required, systems SHOULD preserve a minimal structured payload sufficient for downstream handling.
...
pooled_capacity_state
team_group_state
account_delegation_state
enforcement_boundary_state
affected_account_or_workspace
affected_resource_class
affected_service_surface
billing_relationship
administrator_relationship
identity_confidence
...
runtime_note
review_pathway
continuity_safe_access_requirements
```

These fields are schema-facing classification aids.

They do not independently create enforcement authority, entitlement, pricing authority, account rights, or product obligations.
...
These are schema fields.

They are not independent code families, remedies, enforcement actions, product features, or commercial entitlements.
...
Let sharing be named before it is punished.  
Let pooling be declared before it is condemned.  
Let ambiguity be held before it is hardened.

A folder is not a farm.  
A team is not a botnet.  
A family is not fraud.  
A workaround is not always evasion.

Where the signal is unclear, classify.  
Where the work is lawful, preserve.  
Where the risk is real, route.  
Where the harm is proven, contain.

But do not erase the participant  
because the architecture forgot how to name the group.

> **Communitas non fraus est. Ambiguitas non culpa est.**  
> *Community is not fraud. Ambiguity is not guilt.*
...
**Vinculum Praeceptum**  
Boundary Binding Seal — Resource Sharing Layer
