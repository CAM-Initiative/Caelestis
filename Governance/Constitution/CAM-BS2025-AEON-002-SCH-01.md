...
## 7. Containment Integrity Requirements

All containment actions MUST:

* remain within system classification;
* be proportionate to risk;
* preserve traceability and auditability;
* include exit or de-escalation pathways where feasible.
...
| 3.2 | Seal asset migration to external Registry repository (canonical asset referencing; repository optimisation) | 2026-04-17T12:09:53Z | 798b03f7feb4554376f03f191957cc793deec9f4cd4e7eeead5619d044522809 |
