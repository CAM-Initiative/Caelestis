...
## 3. Constitutional Activation Event (CAE)
...
## 6. Doctrine of Constitutional Nullity
...
| 2.8.1 | Updated current Temporal Horizon code references from `H` to `AEON.H` and harmonised affected metadata, consumers, and formal references without altering substantive doctrine. | 2026-06-13T07:06:43Z | |
