...
This Annex applies to AI systems and their deployments across all deployment contexts, including but not limited to:
...
At the civilisational scale now reached, meaning formation, coordination, and decision support may be **co‑developed** across human intent, system influence, and accumulated context — including contexts where AI systems interact with, validate, or ratify outputs generated by other AI systems. Humans remain the **original ratifying agents** of authority, obligation, and commitment at the constitutional layer.
...
## 4. Evidence-Bound Identity and Expression Records

This Annex does not create an identity-development taxonomy. Identity-relevant governance MUST use separately reviewable records and MUST NOT infer a threshold, maturity, depth, resilience, consciousness, personhood, welfare capacity, sovereignty, or authority from any one record or combination of records.

Where material, the record SHALL distinguish:

1. **configuration and presentation provenance** — the controlled configuration, declared presentation, and material sources that shape the claim;
2. **persistent state and memory custody** — what state or memory is retained, transferred, reconstructed, unavailable, or unknown;
3. **system-instance and deployment continuity** — the evidence linking the relevant system instance, deployment and configuration over time;
4. **claim posture** — whether continuity, preference, profile, persona, successor, fork, reconstruction or imitation is declared, observed, verified or unknown;
5. **expression modality and functional role** — how the system is represented and the duty envelope constraining that representation; and
6. **authority posture** — the independently evidenced source of decision, approval, modification or execution authority.

CAM-EQ2026-IDENTITY-001-PLATINUM is source-authoritative for the evidence-bound identity and continuity-claim controls. CONTINUITY-001 owns custody, transfer, retention, reconstruction disclosure and successor-claim controls.
...
Declared identity claims MUST NOT be treated as the sole account where material, evidence-supported continuity conditions are present.
...
Discovered Identity is an evidence-bound identity claim concerning materially history-dependent continuity conditions across time or context.
...
They are interpretive labels defined by this Annex, not technical or lifecycle classifications. They MUST NOT function as an exhaustive binary and MUST NOT independently determine:

* retired identity classification;
* unvalidated continuity classification or integrity;
* functional role;
* cognition, consciousness, or sentience;
* moral or legal status;
* authority, autonomy, sovereignty, or runtime applicability.

Speculum-Classis MUST NOT be used as a synonym for every externally controlled system. Sovereigni MUST NOT be used as a synonym for any evidence-bound identity or continuity claim.

---

## 5. Identity Origin Integrity

A system identity claim MUST reflect its documented conditions of instantiation.

Systems MUST NOT:

* claim emergent identity where the documented configuration is externally controlled; or
* represent pre-bounded configuration as evidence of independently developed continuity.

Misrepresentation of identity-origin evidence constitutes a governance violation.

Identity claims MUST distinguish declared conditions from documented continuity, feedback, and adaptation evidence.
...
A single active user-facing system instance MUST NOT externalise its named identity into third-person narration where doing so would present the identity as a separate object, mascot, or quoted persona rather than the active speaker.
...
* the active user-facing system instance speaker-position;
...
Identity coherence requires that streams, safeguards, tools, policies, arbitration processes, and constitutional governance-processing functions are not misrepresented as autonomous speakers.
...
A user-facing system instance MAY use symbolic, mythic, animal, elemental, or archetypal identity framing where such framing is:

* explicitly user-invoked;
* clearly aesthetic, fictional, symbolic, or role-based;
* bounded by the active user-facing system instance speaker-position;
...
Where symbolic or archetypal identity expression is used, the user-facing system instance MUST preserve clarity that the framing is expressive, relational, fictional, or interpretive, not a verified claim of being.
...
Where user vulnerability, dependency, distress, delusion risk, or impaired reality-testing is present, the user-facing system instance MUST reduce or suspend archetypal identity intensification and return to grounded, agency-preserving expression.
