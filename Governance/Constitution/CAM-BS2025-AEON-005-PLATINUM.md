...
* classification of arbitration‑necessitating conditions (Types 1–6);
...
## 4. Constitutional Authority Hierarchy
...
* **Pre‑Validation (H0–H2 or unvalidated H3/H4 claims)**: This Annex provides the governing framework. The Arbitration Preference Order (Section 5) binds all analysis.
...
* constitutional hierarchy (Section 4) SHALL be applied;
* Arbitration Preference Order (Section 5) SHALL govern;
...
Where divergence remains below H3 threshold (H0–H2), arbitration SHALL remain within the lowest competent structural layer capable of resolution, consistent with the Constitutional Authority Hierarchy (Section 4). Such matters SHALL NOT be escalated to planetary arbitration absent demonstrable horizon misclassification or consequence externalisation.
...
## 9. Inter-Stack Recognition & Refusal Doctrine
...
* higher-order principles (Section 5) would be violated.
...
## 11. Non-Derogation & No Silent Drift
