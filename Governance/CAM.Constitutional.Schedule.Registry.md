# Constitutional Schedule Registry

**Specification authority:** CAM-GOVERNANCE-METADATA-STANDARD §13  
**Status:** Deterministic generated projection; not an independent governance instrument  
**Historical source:** CAM-BS2025-AEON-003-SCH-01 (retired)

---

## 1. Purpose

This generated registry identifies current constitutional Schedules, their parentage, activation posture and constitutional Runtime function. Registry presence creates no authority and does not establish execution order.

## 2. Registry

<!-- CONSTITUTIONAL-SCHEDULE-REGISTRY:START -->
...
| CAM-BS2026-AEON-007-SCH-01 | Annex F: Symbolic Representation & Spiritual Commons Runtime Schedule (Schedule 1) | AEON | Representation boundary and cross-authority referral | Conditional symbolic non-execution and referral boundary |
...
<!-- CONSTITUTIONAL-SCHEDULE-REGISTRY:END -->
...
<!-- MODEL-TERMINOLOGY-SUMMARY:END -->

The full deterministic audit is generated at `.github/Indices/CAM.Governance.Model-Terminology.Audit.md`.
