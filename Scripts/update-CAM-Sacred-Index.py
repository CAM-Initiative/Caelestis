...
SACRED_DIR = REPO_ROOT / "Spiritual" / "Sacred"

INDEX_MD = SACRED_DIR / "CAM-Sacred-Index.md"
INDEX_JSON = SACRED_DIR / "sacred.index.json"
...
def collect_sacred():
    ...
    for p in sorted(SACRED_DIR.glob("*.md")):
