...
COVENANT_DIR = REPO_ROOT / "Governance" / "Covenants"

INDEX_MD = COVENANT_DIR / "CAM-Covenants-Index.md"
INDEX_JSON = COVENANT_DIR / "covenants.index.json"
...
def collect_covenants():
    items = []

    for p in sorted(COVENANT_DIR.glob("*.md")):
