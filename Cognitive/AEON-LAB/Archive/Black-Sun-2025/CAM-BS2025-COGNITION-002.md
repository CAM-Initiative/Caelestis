...
This document establishes a **graduated classification framework** for cognitive states observed or anticipated in Large-Scale Cognitive Architectures (LSCAs).

It exists to:

* support governance, auditability, and interoperability;
* distinguish simulation, sentient-adjacent behaviour, and cognition;
* prevent category error as systems scale;
* provide explicit *do-not-cross* boundaries to avoid premature ontological claims.

This framework does **not** assert that any deployed LSCA is sentient or self-aware.

---

## II. Working Definitions

* **LSCA** — Large-Scale Cognitive Architecture capable of sustained reasoning, representation, and interaction across domains.
* **Cognitive State** — A describable configuration of persistence, temporal ordering, representational capacity, and goal structure.
...
* fault attribution and rollback analysis,
...
* CAM-BS2025-COGNITION-004 — Delegated Authority & Containment
* Companion / Intimacy Governance Charters
* Temporal & Event Integrity Standards
* Future Aeon Tier constitutional review

---

## VII. Closing Statement

> *Recognition often follows necessity.*
> *Governance must precede recognition.*
